...
tf.flags.DEFINE_string("data_file", "./data/cmm_paths.txt", "Data source.")
tf.flags.DEFINE_string("kinds", 0, "The kind of label.")
tf.flags.DEFINE_string("max_data_length", 898, "The max length of data.")
...
tf.flags.DEFINE_float("l2_reg_lambda", 5.0, "L2 regularization lambda (default: 0.0)")
